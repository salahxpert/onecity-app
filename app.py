...
def init_users():
    try:
        ...
        logger.error(f"init_users error: {e}")
        logger.error(traceback.format_exc())
    ...
    def decorated_function(*args, **kwargs):
        try:
            if 'user_id' not in session:
                logger.warning("Session user_id missing, redirecting to login")
...
try:
    ...
    logger.warning(f"Scheduler could not start (normal on PythonAnywhere): {e}")
    scheduler = None
...
class GoogleSheetSync:
        ...
        try:
            ...
            if creds_json:
                try:
                    ...
                    self.available = True
                    logger.info("Google Sheets authenticated via GOOGLE_CREDENTIALS")
                    return
                except Exception as e:
                    logger.error(f"Error parsing GOOGLE_CREDENTIALS: {e}")
                    logger.error(traceback.format_exc())
            else:
                logger.warning("GOOGLE_CREDENTIALS environment variable not set.")
            self.available = False
            self.client = None
        except Exception as e:
    ...
    def _load_sheet_list(self):
        if not self.available:
            logger.warning("Google Sheets not available, skipping sheet list load")
            return
        try:
    ...
    def _insert_data(self, table_name, headers, rows, source_sheet):
        ...
        try:
            ...
            logger.error(f"_insert_data error: {e}")
            logger.error(traceback.format_exc())
            return 0
    ...
    def write_to_sheet(self, table_name, row_data, sheet_name=None):
        if not self.available:
            logger.warning("Google Sheets not available, cannot write")
            return False
        try:
            sheet_id = None
            if sheet_name:
...
def serve_static(path):
    try:
        ...
        logger.error(f"serve_static error: {e}")
        logger.error(traceback.format_exc())
        return "Static file error", 500
...
def serve_sw():
    try:
        ...
        logger.error(f"serve_sw error: {e}")
        logger.error(traceback.format_exc())
        return "SW error", 500
...
def db_check():
    try:
        ...
        if table_exists:
            ...
            conn.close()
            return jsonify({'table_exists': False, 'message': 'Users table not found'})
    except Exception as e:
...
def login_page():
    try:
        ...
        logger.error(f"login_page error: {e}")
        logger.error(traceback.format_exc())
...
def api_login():
    try:
        ...
        logger.error(f"api_login error: {e}")
        logger.error(traceback.format_exc())
...
def update_salary(id):
    try:
        ...
        logger.error(f"update_salary error: {e}")
        logger.error(traceback.format_exc())
        return jsonify({'error': 'Server error'}), 500
...
def add_collection_form():
    try:
        ...
        logger.error(f"add_collection_form error: {e}")
        logger.error(traceback.format_exc())
        return "Add collection error", 500
...
def edit_collection_form(mr_id):
    try:
        ...
        logger.error(f"edit_collection_form error: {e}")
        logger.error(traceback.format_exc())
        return "Edit collection error", 500
...
def collections_list():
    try:
        ...
        logger.error(f"collections_list error: {e}")
        logger.error(traceback.format_exc())
        return "Collections list error", 500
...
def client_ledger(client_id):
    try:
        ...
        logger.error(f"client_ledger error: {e}")
        logger.error(traceback.format_exc())
        return "Client ledger error", 500
...
def client_ledgers_list():
    try:
        ...
        logger.error(f"client_ledgers_list error: {e}")
        logger.error(traceback.format_exc())
        return "Client ledgers error", 500
...
def emi_track():
    try:
        ...
        logger.error(f"emi_track error: {e}")
        logger.error(traceback.format_exc())
        return "EMI track error", 500
...
def employees_list():
    try:
        ...
        logger.error(f"employees_list error: {e}")
        logger.error(traceback.format_exc())
        return "Employees list error", 500
...
def salary_page():
    try:
        ...
        logger.error(f"salary_page error: {e}")
        logger.error(traceback.format_exc())
        return "Salary page error", 500
...
def conveyance_page():
    try:
        ...
        logger.error(f"conveyance_page error: {e}")
        logger.error(traceback.format_exc())
        return "Conveyance page error", 500
...
def chq_register():
    try:
        ...
        logger.error(f"chq_register error: {e}")
        logger.error(traceback.format_exc())
        return "CHQ register error", 500
...
def car_requisition():
    try:
        ...
        logger.error(f"car_requisition error: {e}")
        logger.error(traceback.format_exc())
        return "Car requisition error", 500
...
def deed_movement():
    try:
        ...
        logger.error(f"deed_movement error: {e}")
        logger.error(traceback.format_exc())
        return "Deed movement error", 500
...
def token_money():
    try:
        ...
        logger.error(f"token_money error: {e}")
        logger.error(traceback.format_exc())
        return "Token money error", 500
...
def courier():
    try:
        ...
        logger.error(f"courier error: {e}")
        logger.error(traceback.format_exc())
        return "Courier error", 500
...
def hotel_reservation():
    try:
        ...
        logger.error(f"hotel_reservation error: {e}")
        logger.error(traceback.format_exc())
        return "Hotel reservation error", 500
...
def gift_ledger():
    try:
        ...
        logger.error(f"gift_ledger error: {e}")
        logger.error(traceback.format_exc())
        return "Gift ledger error", 500
...
def mr_delivery():
    try:
        ...
        logger.error(f"mr_delivery error: {e}")
        logger.error(traceback.format_exc())
        return "MR delivery error", 500
...
def check_requisition():
    try:
        ...
        logger.error(f"check_requisition error: {e}")
        logger.error(traceback.format_exc())
        return "Check requisition error", 500
...
def admin_table(table):
    ...
    try:
        ...
        logger.error(f"admin_table error: {e}")
        logger.error(traceback.format_exc())
        return "Admin table error", 500
...
def admin_edit(table, id):
    ...
    try:
        ...
        logger.error(f"admin_edit error: {e}")
        logger.error(traceback.format_exc())
        return "Admin edit error", 500
...
def view_sheet(table, sheet_name):
    ...
    try:
        ...
        logger.error(f"view_sheet error: {e}")
        logger.error(traceback.format_exc())
        return "View sheet error", 500
...
def db_stats():
    try:
        ...
        logger.error(traceback.format_exc())
        return jsonify({'error': 'DB stats failed'}), 500
...
def get_table_data(table_name):
    ...
    try:
        ...
        logger.error(traceback.format_exc())
        return jsonify({'error': 'Table data failed'}), 500
...
def add_collection():
    try:
        ...
        logger.error(f"add_collection error: {e}")
        logger.error(traceback.format_exc())
        return jsonify({'error': 'Add collection failed'}), 500
...
def edit_collection(mr_id):
    try:
        ...
        logger.error(f"edit_collection error: {e}")
        logger.error(traceback.format_exc())
        return jsonify({'error': 'Edit collection failed'}), 500
...
def set_google_sheet():
    ...
    try:
        ...
        logger.error(f"set_google_sheet error: {e}")
        logger.error(traceback.format_exc())
...
def get_google_sheet():
    ...
    try:
        ...
        logger.error(f"get_google_sheet error: {e}")
        logger.error(traceback.format_exc())
...
def google_config():
    try:
        ...
        logger.error(f"google_config error: {e}")
        logger.error(traceback.format_exc())
        return "Google config error", 500
